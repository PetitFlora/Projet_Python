...
IMAGES = {
    # Vaisseaux joueur
    "X-Wing": pygame.image.load("./joueur/x-wing1.png"),
    "Y-Wing": pygame.image.load("./joueur/y-wing.png"),
    "Faucon": pygame.image.load("./joueur/faucon2.png"),
    "Tie-Fighter": pygame.image.load("./joueur/tie-fighter.png"),
    "Tie-Bombardier": pygame.image.load("./joueur/tie-bombardier.png"),
    "Destroyer Imperial": pygame.image.load("./joueur/Imperial_destroyer2.png"),

    # Vaisseaux ennemis
    "X-Wing Ennemi": pygame.image.load("./ennemi/x-wing1.png"),
    "Y-Wing Ennemi": pygame.image.load("./ennemi/y-wing.png"),
    "Faucon Ennemi": pygame.image.load("./ennemi/faucon2.png"),
    ...
    "Destroyer Imperial Ennemi": pygame.image.load("./ennemi/Imperial_destroyer2.png"),
    ...
    "Etoile 0" : pygame.image.load('etoiles0.png'),
    "Etoile 1" : pygame.image.load('etoiles1.png'),
    "Etoile 2" : pygame.image.load('etoiles2.png'),
    "Etoile 3" : pygame.image.load('etoiles3.png'),
...
StatsVaisseaux = namedtuple('StatsVaisseaux', 
    ['image', 'vitesse', 'puissance_tir', 'balle'])

stats_vaisseaux = {
    "X-Wing": StatsVaisseaux(IMAGES["X-Wing"], 2.5, 1, 1),
    "Y-Wing": StatsVaisseaux(IMAGES["Y-Wing"], 1.25, 1, 1),
    "Faucon": StatsVaisseaux(IMAGES["Faucon"], 1.875, 1, 1),
    "Tie-Fighter": StatsVaisseaux(IMAGES["Tie-Fighter"], 2.5, 1, 2),
    "Tie-Bombardier": StatsVaisseaux(IMAGES["Tie-Bombardier"], 1.25, 1, 2),
    "Destroyer Imperial": StatsVaisseaux(IMAGES["Destroyer Imperial"], 1.875, 1, 2)
}
...
class Joueur():
    ...
    def __init__(self, type):
        ...
        self.puissance_tir = self.type_stats.puissance_tir
        self.bouclier = False
        self.sens = None
        self.score = 0
        self.vie = 1000
